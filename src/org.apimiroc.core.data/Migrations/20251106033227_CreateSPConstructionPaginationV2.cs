...
{
    /// <inheritdoc />
    public partial class CreateSPConstructionPaginationV2 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"
                CREATE PROCEDURE getConstructionPaginationAdvancedWithUniqueKeysRelations
                    @PageIndex INT = 1,
                    @PageSize INT = 10,
                    @Q NVARCHAR(200) = NULL,
        ...
        {
            migrationBuilder.Sql("DROP PROCEDURE IF EXISTS getConstructionPaginationAdvancedWithUniqueKeysRelations;");
        }
    }
}
