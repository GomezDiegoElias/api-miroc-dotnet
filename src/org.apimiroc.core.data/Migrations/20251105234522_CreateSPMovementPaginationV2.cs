...
{
    /// <inheritdoc />
    public partial class CreateSPMovementPaginationV2 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"
                CREATE PROCEDURE getMovementPaginationAdvancedWithUniqueKeysRelations
                    @PageIndex INT = 1,
                    @PageSize INT = 10,
                    @Q NVARCHAR(200) = NULL,
                ...
                BEGIN
                    ...
                    (
                        SELECT
                            ...
                            cli.dni AS client_dni,
			                prv.cuit AS provider_cuit,
			                emp.dni AS employee_dni,
        ...
        {
            migrationBuilder.Sql("DROP PROCEDURE IF EXISTS getMovementPaginationAdvancedWithUniqueKeysRelations;");
        }
    }
}
